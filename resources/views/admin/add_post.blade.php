          ...
          <form method="POST" action="{{route('posts.store')}}" enctype="multipart/form-data">
            ...
            <div class="form-row">
              <div style="width: 600px;" class="form-group col-md-6">
                ...
                <input type="text" class="form-control" name="title_en" placeholder="Enter Post Title English">
              ...
              <div style="width: 600px;" class="form-group col-md-6">
                ...
                <input type="text" class="form-control text-right" name="title_ar" placeholder="أدخل عنوان المنشور">
            ...
            <div class="form-row">
              <div style="width: 600px;" class="form-group col-md-6">
                ...
                <label for="note">body En</label>
                <textarea class="form-control" rows="3" name="body_en" id="note" placeholder="Enter Content of post ..."></textarea>
                <label class="text-danger"> {{$errors->first("body_en")}}</label>
              </div>
              <div style="width: 600px;" class="form-group col-md-6">
                <div class="text-right">
                  <label>محتوي المنشور</label>
                </div>
                <textarea class="form-control text-right" rows="3" name="body_ar" id="note" placeholder=" ...ادخل محتوى المنشور"></textarea>
                <label class="text-danger"> {{$errors->first("body_ar")}}</label>
              </div>
